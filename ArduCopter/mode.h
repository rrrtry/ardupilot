...
protected:
    ...
    const char *name4() const override { return "JIDO"; }
...
class ModePowerless : public Mode {
...
protected:
    ...
    const char *name() const override { return "POWERLESS"; }
    const char *name4() const override { return "POWE"; }
